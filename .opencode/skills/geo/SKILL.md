...
|----------|------|---------------|
| geo-ai-visibility | `.opencode/agent/geo-ai-visibility.md` | GEO audit, citability, AI crawlers, llms.txt, brand mentions |
| geo-platform-analysis | `.opencode/agent/geo-platform-analysis.md` | Platform-specific optimization (ChatGPT, Perplexity, Google AIO) |
| geo-technical | `.opencode/agent/geo-technical.md` | Technical SEO, Core Web Vitals, crawlability, indexability |
| geo-content | `.opencode/agent/geo-content.md` | Content quality, E-E-A-T, readability, AI content detection |
| geo-schema | `.opencode/agent/geo-schema.md` | Schema markup detection, validation, generation |
...
|---|-------|-----------|---------|
| 1 | geo-audit | `.opencode/skills/geo-audit/` | Full audit orchestration and scoring |
| 2 | geo-citability | `.opencode/skills/geo-citability/` | Passage-level AI citation readiness |
| 3 | geo-crawlers | `.opencode/skills/geo-crawlers/` | AI crawler access and robots.txt |
| 4 | geo-llmstxt | `.opencode/skills/geo-llmstxt/` | llms.txt standard analysis and generation |
| 5 | geo-brand-mentions | `.opencode/skills/geo-brand-mentions/` | Brand presence on AI-cited platforms |
| 6 | geo-platform-optimizer | `.opencode/skills/geo-platform-optimizer/` | Platform-specific AI search optimization |
| 7 | geo-schema | `.opencode/skills/geo-schema/` | Structured data for AI discoverability |
| 8 | geo-technical | `.opencode/skills/geo-technical/` | Technical SEO foundations |
| 9 | geo-content | `.opencode/skills/geo-content/` | Content quality and E-E-A-T |
| 10 | geo-report | `.opencode/skills/geo-report/` | Client-ready deliverable generation |
...
|-------|------|-------------|
| geo-ai-visibility | `.opencode/agent/geo-ai-visibility.md` | geo-citability, geo-crawlers, geo-llmstxt, geo-brand-mentions |
| geo-platform-analysis | `.opencode/agent/geo-platform-analysis.md` | geo-platform-optimizer |
| geo-technical | `.opencode/agent/geo-technical.md` | geo-technical |
| geo-content | `.opencode/agent/geo-content.md` | geo-content |
| geo-schema | `.opencode/agent/geo-schema.md` | geo-schema |
...
3. Execute the PDF generator: `python3 ~/.config/opencode/skills/geo/scripts/generate_pdf_report.py data.json GEO-REPORT.pdf`
